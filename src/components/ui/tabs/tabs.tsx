...
const tabsVariants = tv({
  slots: {
    ...
    trigger: [
      "inline-flex flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-md border border-transparent px-2 py-1 text-sm font-medium whitespace-nowrap text-text-default-secondary transition-[color,box-shadow]",
      "hover:text-text-default-default focus-visible:ring-4 focus-visible:ring-background-brand-default/25 focus-visible:outline-none disabled:pointer-events-none",
      "data-[state=active]:bg-background-default-default data-[state=active]:text-text-default-default data-[state=active]:shadow-sm",
    ],
